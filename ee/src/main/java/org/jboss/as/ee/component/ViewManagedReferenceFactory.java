...
final class ViewManagedReferenceFactory implements ManagedReferenceFactory {
    private final NewComponentView view;
     ...
     */
    public ViewManagedReferenceFactory(final NewComponentView view) {
        this.view = view;
    }
    ...
    /**
     * The bridge injector for binding views into JNDI.  Injects a {@link NewComponentView}
     * wrapped as a {@link ManagedReferenceFactory}.
     */
    static class Injector implements org.jboss.msc.inject.Injector<NewComponentView> {
        ...
        /** {@inheritDoc} */
        public void inject(final NewComponentView value) throws InjectionException {
