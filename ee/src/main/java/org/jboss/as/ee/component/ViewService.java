 ...
 */
final class ViewService implements Service<NewComponentView> {
    ...
    private volatile NewComponentView view;
    ...
    ViewService(final ViewConfiguration viewConfiguration) {
        ...
        for (Method method : methods) {
            if (method.getName().equals("finalize") && method.getParameterTypes().length == 0) {
                clientInterceptorFactories.put(method, clientPreDestroy);
            } else {
    ...
    public void start(final StartContext context) throws StartException {
        ...
        controller.compareAndSetMode(ServiceController.Mode.ON_DEMAND, ServiceController.Mode.ACTIVE);

        // Construct the view
        view = new View(Collections.unmodifiableCollection(Arrays.asList(proxyFactory.getCachedMethods())));
    }
    ...
    public NewComponentView getValue() throws IllegalStateException, IllegalArgumentException {
        return view;
    }

    class View implements NewComponentView {

        private final Collection<Method> allowedMethods;
        private final Component component;

        View(final Collection<Method> allowedMethods) {
        ...
        public ComponentViewInstance createInstance() {
            ...
            try {
                ...
                context.putPrivateData(NewComponentView.class, this);
        ...
        class ViewInstance implements ComponentViewInstance {
            ...
            public Object createProxy() {
                ...
                try {
                    Object object = proxyFactory.newInstance(new NewProxyInvocationHandler(clientEntryPoints));
                    InterceptorContext interceptorContext = new InterceptorContext();
                    interceptorContext.putPrivateData(NewComponentView.class, View.this);
