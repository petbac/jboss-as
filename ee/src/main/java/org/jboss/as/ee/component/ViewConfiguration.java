...
public class ViewConfiguration {
     ...
     */
    public ViewConfiguration(final Class<?> viewClass, final AbstractComponentConfiguration componentConfiguration, final ServiceName viewServiceName, final ProxyFactory<?> proxyFactory) {
